...
autocmd BufWritePost index.md,about-me.md,software.md,selfhosting.md,projects.md,clues.md,_header.html,_footer.html ! ssg5 ~/builds/website_md ~/builds/website "A Missing Link" "https://amissing.link" && sh $HOME/builds/website/.git/hooks/pre-commit
