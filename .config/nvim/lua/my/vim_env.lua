...
vim.env.WEBSITE_DOMAIN =
	vim.env.WEBSITE_DOMAIN or
	'www.anthes.is'

vim.env.WEBSITE_SRC_DIR =
	vim.env.WEBSITE_SRC_DIR or
	os.getenv('HOME') .. '/src/website_md'

vim.env.WEBSITE_DEST_DIR =
	vim.env.WEBSITE_DEST_DIR or
	'/var/www/htdocs/' .. vim.env.WEBSITE_DOMAIN
