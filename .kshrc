...
alias seint="se /etc/X11/xorg.conf.d/90-intel.conf"
...
alias mutt="neomutt"
alias axel="axel -a -v"
alias tskctchup="yes | task done \$(task due.before:today ids)"
alias tsktd="task list due:today"
alias tsktch="task list project:tech"
alias tskaddtch="task add project:tech"
alias tskslf="task list project:selfcare"
alias tskaddslf="task add project:selfcare"
alias tskshp="task list project:shopping"
alias tskaddshp="task add project:shopping"
alias tskdn="task done"
alias n="nnn"
